...
class HomeEasySectionBackupController extends Controller
{
    public function index()
{
    $HomeEasyBook = HomeEasyBookingModel::paginate(10); // Tambahkan pagination
    return view('home.home_easy_booking.index', compact('HomeEasyBook'));
}
    ...
    public function store(Request $request){
        ...
        return redirect()->route('dashboard.home-easy-section.index');
    }
